...
|-----------------------|----------|
| ![Main window — map, MARKERS panel, SETTINGS in top bar](docs/screenshots/main-window.png) | ![Settings — screenshot folder, resolution, overlay opacity, About v2.7.6](docs/screenshots/settings.png) |
...
| **About** | App name and version (**2.7.6**), **Check for updates** (GitHub Releases) |
