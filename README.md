...
|-----------------------|----------|
| ![Main window — map, MARKERS panel, SETTINGS in top bar](docs/screenshots/main-window.png) | ![Settings — screenshot folder, resolution, overlay opacity, About v2.7.7](docs/screenshots/settings.png) |
...
| **About** | App name and version (**2.7.7**), **Check for updates** (downloads and installs from GitHub Releases) |
